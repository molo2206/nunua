...
abstract class UsageRecordOptions {
     ...
     * @param string $isoCountry Alpha-2 ISO CountryModel Code. Only show UsageRecords
...
class ReadUsageRecordOptions extends Options {
    ...
    /**
     * Alpha-2 ISO CountryModel Code. Only show UsageRecords representing usage in this country.
     *
     * @param string $isoCountry Alpha-2 ISO CountryModel Code. Only show UsageRecords
     *                           representing usage in this country.
     * @return $this Fluent Builder
